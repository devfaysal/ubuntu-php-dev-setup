...
```sudo apt install php8.5 php8.5-cli php8.5-fpm php8.5-bcmath php8.5-curl php8.5-gd php8.5-intl php8.5-mbstring php8.5-mysql php8.5-sqlite3 php8.5-xml php8.5-zip libapache2-mod-php8.5 php8.5-common```
